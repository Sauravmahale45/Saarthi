...
/// ─────────────────────────────────────────
/// Traveler Parcel Details Screen
/// ─────────────────────────────────────────

class TravelerParcelDetailsScreen extends StatefulWidget {
  final String parcelId;

  const TravelerParcelDetailsScreen({
    super.key,
...
class _TravelerParcelDetailsScreenState
  ...
  Future<void> _startTracking() async {
    final ok = await PermissionService.ensureLocationReady(context);
  ...
  Future<void> _startPickup() async {
    ...
    await Navigator.push(
      context,
      MaterialPageRoute(
        builder: (_) => PickupOTPVerifyScreen(
  ...
  Future<void> _markDelivered() async {
    ...
    try {
      ...
      _toast("Parcel delivered! Earnings added.");
    } catch (e) {
      _toast(e.toString(), isError: true);
    }
        ...
        SliverPadding(
          ...
          sliver: SliverList(
            delegate: SliverChildListDelegate([
              ...
              _earningsCard(price, commission, earning),
  ...
  Widget _parcelInfo(Map p) {
    return _buildCard(
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          const Text("Parcel Info", style: TextStyle(fontWeight: FontWeight.bold)),
          const SizedBox(height: 10),
  ...
  Widget _earningsCard(double price, double commission, double earn) {
    return _buildCard(
      child: Column(
        children: [
          Row(
